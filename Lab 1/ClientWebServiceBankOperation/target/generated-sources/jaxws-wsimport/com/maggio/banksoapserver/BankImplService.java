 ...
 * 
 */
@WebServiceClient(name = "BankImplService", targetNamespace = "http://banksoapserver.maggio.com/", wsdlLocation = "http://localhost:9000/bank?wsdl")
    ...
    extends Service
{
    ...
    private final static QName BANKIMPLSERVICE_QNAME = new QName("http://banksoapserver.maggio.com/", "BankImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9000/bank?wsdl");
    ...
    public BankInterface getBankImplPort() {
        return super.getPort(new QName("http://banksoapserver.maggio.com/", "BankImplPort"), BankInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "BankImplPort")
    public BankInterface getBankImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://banksoapserver.maggio.com/", "BankImplPort"), BankInterface.class, features);
    }
